...
function cards(data){
    ...
    newArrivals.insertAdjacentHTML("beforeend", '<a href="./product.html"><div class="newArrivalCards"><div style="position: relative ;"><div class="heart cardsHeart"><img src="heart.svg"></div></div><img class="cardImg" src="image.png" alt=""><h4>'+data[i].productName+'</h4><h3>Rs. '+data[i].productPrice+'</h3><div class="cardBtn"><img src="bag_In.svg"></div></div></a>')
}
}
